...
; =====================================================================
;
; Insert the information relevant to your addin.
...
#define SEMANTIC_VERSION "1.0.0.6"

; The version in four-number format
#define FOUR_NUMBER_VERSION "1.0.0.6"
...
#define APP_GUID "{{03BA69DD-072A-4F90-896D-B03365228339}"
#define ADDIN_NAME "AutomationDesigner"
...
#define ADDIN_SHORT_NAME "AutomationDesigner"

#define COMPANY "AutomationDesigner"
#define DESCRIPTION "Solidworks / Inventor Automation using Excel Add in."
#define HOMEPAGE "https://github.com/Screaminlean/SCL-AutomationDesigner"
#define HOMEPAGE_SUPPORT "https://github.com/Screaminlean/SCL-AutomationDesigner"
#define HOMEPAGE_UPDATES "https://github.com/Screaminlean/SCL-AutomationDesigner"

; SOURCEDIR is the directory that contains the files that
; need to be installed; e.g. 'MyProject\bin\Release\'.
; Include a trailing slash!
#define SOURCEDIR  "C:\Users\Public\source\repos\SCL-AutomationDesigner\AutomationDesigner\bin\x64\Release\"
...
#define VSTOFILE "AutomationDesigner.vsto"

; OUTPUTDIR is the directory where the installer will be saved.
#define OUTPUTDIR "C:\Users\Public\releases\"
